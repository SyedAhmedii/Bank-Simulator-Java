...
public class SignupThree extends JFrame implements ActionListener {
    ...
    SignupThree(String formno) {
        ...
        r2 = new JRadioButton("Currect Account");
        ...
        r4 = new JRadioButton("Personal Account");
        ...
        c7 = new JCheckBox("I hereby declared that above all Information is correct to best of my knowledge");
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            ...
            // Card Number Generate karne ke liye
