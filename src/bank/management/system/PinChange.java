...
public class PinChange extends JFrame implements ActionListener {
    ...
    PinChange(String pinnumber) {
        ...
        change.setBackground(new Color(144, 238, 144));
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == change) {
            try {
                ...
                if (!npin.equals(rpin)) {
                    JOptionPane.showMessageDialog(null, "Entered PIN Doesn't Matched");
                    return;
                }
                ...
                Conn conn = new Conn();
                // 3 queries isiliye de hai kyuki 3 tables mai porana pin hoga  
                String query1 = "update bank set pin = '"+rpin+"' where pin = '"+pinnumber+"'";
                String query2 = "update login set pin = '"+rpin+"' where pin = '"+pinnumber+"'";
                String query3 = "update signupthree set pin = '"+rpin+"' where pin = '"+pinnumber+"'";
                // kyuki DML command hai tou executeUpdate ki command lagayi hai
